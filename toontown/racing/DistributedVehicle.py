...
class DistributedVehicle(DistributedSmoothNode.DistributedSmoothNode, Kart.Kart, FSM.FSM):
    ...
    def __updateNonlocalVehicle(self, task = None):
        ...
        self.leanAmount = max(-10, min(self.leanAmount, 10))
        self.__animate()
        return Task.cont
    ...
    def __animate(self):
        ...
        enginePitch = max(0.5, min(speed / 120.0, 15))
    ...
    def __watchControls(self, task):
        ...
        pitch += accelBase
        pitch = max(accelBase - 5, min(pitch, accelBase + 5))
